                                                ...
                                                <span class="price">
                                                    <span class="electro-price">
                                                        <ins><span class="amount">   
                                                                    <span class="price">
                                                                        <span class="electro-price">
                                                                            <ins><span class="amount">     {{number_format($row1->items->discount_price)}} {{trans('cpanel.R_S')}}</span></ins>
                                                                            <del><span class="amount">{{number_format($row1->items->fixed_price)}} {{trans('cpanel.R_S')}}</span></del>
                                                                            <span class="amount"> </span>
                                                                        </span>
                                                                    </span></span></ins>
