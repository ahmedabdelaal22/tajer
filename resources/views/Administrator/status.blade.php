            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="add-btn">
                            @if(auth()->user()->id == 1 || in_array('add_status', get_user_permissions()))
                            <a href="{{url('admin/status/create')}}" > <button> ADD NEW </button> </a>
                            @endif
                        </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-app" href="{{url('admin/status/'.$row_data->id.'/edit/')}}">
                                        <i class="fa fa-edit"></i> 
                                    </a>
                                </td>

                                <td>
                                    @if(auth()->user()->id == 1 || in_array('delete_status', get_user_permissions()))
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            {!!  Form::open(['action' => ['Administrator\StatusController@destroy', $row_data->id],'method'=>'DELETE','role'=>'form', 'id'=>'Delete_form']) !!}
