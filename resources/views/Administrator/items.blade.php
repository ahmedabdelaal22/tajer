...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Auction Items</li>
        </ol>
    </section>
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{$row_data->start_bid}}</td>
                                <td>{{$row_data->min_bid}}</td>

                                <td>{{$row_data->items_bids->max('price')}}</td>
                                <?php
                                $start_date_format = date("Y-m-d", strtotime($row_data->start_date));
                                $end_date_format = date("Y-m-d", strtotime($row_data->end_date));
                                ?>
