                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="add-btn">
                            ...
                            <a href="{{url('admin/sub_categories/create?cat_id='.$categories_id)}}" > <button> ADD NEW </button> </a>
                            @endif
                        </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-app" href="{{url('admin/sub_categories/'.$row_data->id)}}">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
                                <td>
                                    <a class="btn btn-app" href="{{url('admin/sub_categories/'.$row_data->id.'/edit/')}}">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            {!!  Form::open(['action' => ['Administrator\SubCategoriesController@destroy', $row_data->id],'method'=>'DELETE','role'=>'form', 'id'=>'Delete_form']) !!}
