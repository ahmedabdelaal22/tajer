            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        @if(!empty($admin_data))
                        {!! Form::model($admin_data,['method'=>'PATCH','files'=>true,'url'=>'/admin/brands/'.$admin_data->id, 'id'=>'form_sample_3','role'=>'form',' accept-charset'=>'UTF-8']) !!}
                        @else
                        {!! Form::open(['method'=>'POST','files'=>true,'id'=>'form_sample_3','action'=>'Administrator\BrandsController@store','role'=>'form',' accept-charset'=>'UTF-8']) !!}
                        @endif
