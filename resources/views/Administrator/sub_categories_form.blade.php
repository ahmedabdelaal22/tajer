            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        @if(!empty($admin_data))
                        {!! Form::model($admin_data,['method'=>'PATCH','files'=>true,'url'=>'/admin/sub_categories/'.$admin_data->id, 'id'=>'form_sample_3','role'=>'form',' accept-charset'=>'UTF-8']) !!}
                        @else
                        {!! Form::open(['method'=>'POST','files'=>true,'id'=>'form_sample_3','action'=>'Administrator\SubCategoriesController@store','role'=>'form',' accept-charset'=>'UTF-8']) !!}

                        <?php $categories_id = $_GET['cat_id']; ?>
                        @endif
                        ...
                        <div class="box-footer">
                            {!! Form::hidden('categories_id',$categories_id, array('id'=>'categories_id') ) !!}
