...
class BrandsController extends Controller {
    ...
    public function index() {
        ...
        return view(AD . '.brands')->with($data);
    }
    ...
    public function store(Request $request) {
        ...
        if ($validator->fails()) {
            ...
            if (!empty($request->file('image'))) {
                ...
                $path = public_path() . '/uploads/brands/' . $date_path;
                ...
                if ($request->file('image')->move($path, $file_name)) {
                    ...
                    $img = 'public/uploads/brands/' . $date_path . $file_name;
                    $add->image = $img;
                }
            }
            $add->save();
    ...
    public function edit($id) {
        $admin_data = Brands::findOrFail($id);
        $data = [
            'title' => 'site_name',
            'page_title' => 'add_admin',
            'form_title' => 'admin_form',
